...
public class CountStudents {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(countStudents.countStudents2(new int[]{1,1,1,0,0,1},new int[]{1,0,0,0,1,1}));//3
        System.out.println(countStudents.countStudents2(new int[]{1,1,0,0},new int[]{0,1,0,1}));//0
    }
}
